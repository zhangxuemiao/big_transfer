...
def argparser(known_models):
    ...
    parser.add_argument("--model", choices=list(known_models), default='BiT-S-R50x1',
    ...
    parser.add_argument("--dataset", choices=list(bit_hyperrule.known_dataset_sizes.keys()), default='cifar10',
